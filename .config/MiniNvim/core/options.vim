...
" Minimum columns to keep left and right of cursor when scrolling horizontally
set sidescrolloff=5
...
" Don't ask for confirmation when handling unsaved or read-only files
set noconfirm

set visualbell noerrorbells  " Do not use visual and errorbells
set history=9999  " The number of command and search history to keep
...
" Tilde (~) is oot an operator, thus must be followed by motions like `e` or `w`.
set notildeop
