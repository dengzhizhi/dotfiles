...
nnoremap ,tt :e ~/.config/nvim/ticket.vim<CR><C-L>:setl noma<cr>
nnoremap ,tq :e ~/.config/nvim/saved_macros.vim<CR><C-L>:setl noma<cr>
nnoremap ,tc :e ~/.config/MiniNvim/core/commands.vim<CR><C-L>
nnoremap ,tk :e ~/.config/MiniNvim/core/mappings.vim<CR><C-L>
nnoremap ,tp :e ~/.config/MiniNvim/lua/plugins.lua<CR><C-L>

nnoremap ,ts :e ~/dev/zhizhi/workjournal/obsidian/Pages/Vim/Vim Plugin Shortcuts.md<CR><C-L>:setl bh=delete noswf noma<cr>
nnoremap ,tf :sp ~/.config/nvim/preset-commands.vim<CR><C-L>:setl bh=delete noswf noma<cr>
nnoremap ,tb :sp ~/.config/nvim/bookmarks.md<CR><C-L>:setl bh=delete noswf noma<cr>
